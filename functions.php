...
function _rrze_setup() {
    ...
    define( 'HEADER_IMAGE', '%s/grafiken/header/default.jpg' );

    define( 'HEADER_IMAGE_WIDTH', apply_filters( 'd7_header_image_width', 1321 ) );
    define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'd7_header_image_height',	120 ) );
    ...
    add_theme_support('custom-header', array( 'd7_admin_header_style' ) );
...
if ( ! function_exists( 'd7_admin_header_style' ) ) :
    function d7_admin_header_style() {
    ?>
        <style type="text/css">
            #headimg {
